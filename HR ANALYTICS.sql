...
SELECT ROUND((SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) / COUNT(EmployeeCount)) * 100, 2) as AttritionRate
FROM hr_table;
...
SELECT 
    ...
    ROUND((SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) / SUM(SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END)) OVER ()) * 100, 2) as Percentage_of_Total_Attrition,
    ROUND((SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) / COUNT(*)) * 100, 2) as AttritionPercentage
FROM hr_table
...
## 11. Attrition by JobRole and JobSatisfaction
